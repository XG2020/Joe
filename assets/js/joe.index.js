			...
			if (_.mode === 'default') {
				return `
                    <li class="joe_list__item wow default">
                        <div class="line"></div>
                        <a href="${_.permalink}" class="thumbnail" title="${_.title}" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer">
                        ...
                        <div class="information">
                            <a href="${_.permalink}" class="title" title="${_.title}" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer">
                                <span class="badge" style="display: ${_.type === 'sticky' ? 'inline-block' : 'none'}">置顶</span>${_.title}
                            </a>
                            <a class="abstract" href="${_.permalink}" title="文章摘要" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer">${_.abstract}</a>
                            <div class="meta">
                                <ul class="items">
                                    <li>${_.created}</li>
                                    <li>${_.views} 阅读</li>
                                ...
                                <div class="last" style="display: ${_.category.length ? 'flex' : 'none'}">
                                    ...
                                    <a class="link" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer" href="${_.category.length && _.category[0].permalink}">${_.category.length && _.category[0].name}</a>
                                </div>
                            </div>
                        </div>
                    </li>
