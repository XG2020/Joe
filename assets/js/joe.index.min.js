document.addEventListener("DOMContentLoaded",()=>{if(0!==$(".joe_index__banner .swiper-container").length){let e="horizontal";Joe.IS_MOBILE||2!==$(".joe_index__banner-recommend .item").length||(e="vertical"),new Swiper(".swiper-container",{keyboard:!1,direction:e,loop:!0,autoplay:!0,mousewheel:!0,pagination:{el:".swiper-pagination"},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})}{const e=e=>"default"===e.mode?`
                    <li class="joe_list__item wow default">
                        <div class="line"></div>
                        <a href="${e.permalink}" class="thumbnail" title="${e.title}" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer">
                        ...
                        <div class="information">
                            <a href="${e.permalink}" class="title" title="${e.title}" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer">
                                <span class="badge" style="display: ${"sticky"===e.type?"inline-block":"none"}">置顶</span>${e.title}
                            </a>
                            <a class="abstract" href="${e.permalink}" title="文章摘要" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer">${e.abstract}</a>
                            <div class="meta">
                                <ul class="items">
                                    <li>${e.created}</li>
                                    <li>${e.views} 阅读</li>
                                ...
                                <div class="last" style="display: ${e.category.length?"flex":"none"}">
                                    ...
                                    <a class="link" target="${window.Joe&&window.Joe.LIST_TARGET||'_blank'}" rel="noopener noreferrer" href="${e.category.length&&e.category[0].permalink}">${e.category.length&&e.category[0].name}</a>
                                </div>
                            </div>
                        </div>
                    </li>
