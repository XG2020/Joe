...
<body>
    <div id="Joe">
        ...
        <!--joe大图-->
        <?php if ($this->options->JBig_PostBanner !== "off") : ?>
            <div id="EvanBigBanner" class="evan-big-banner" style="background-image: url('<?php echo _getThumbnails($this)[0] ?>'
);">
                <div class="infomation">
                    <div id="EvanBigBanner_Title" class="title"><?php $this->title(); ?></div>
