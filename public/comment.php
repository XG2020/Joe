    ...
    <?php else : ?>
        <?php if ($this->allow('comment') && $this->options->JCommentStatus !== "off") : ?>
            <div id="<?php $this->respondId(); ?>" class="joe_comment__respond">
                ...
                <?php if ($this->options->JCommentImg === 'on') : ?>
                    <div class="joe_comment__upload-bar" style="display: none;">
...
<style>
    ...
    #joe_comment_upload.file:hover { color: var(--theme); }
    #joe_comment_upload.file input {
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
    ...
    /* 选中文件后向下展开的信息条（标签/表格风格） */
    .joe_comment__upload-bar {
        display: flex;
        align-items: center;
    ...
    .joe_comment__upload-bar .showFileName {
        flex: 1 1 auto;
        min-width: 0;
        font-size: 13px;
        color: var(--main);
    ...
    .joe_comment__upload-bar button {
        flex: 0 0 auto;
        height: 30px;
        padding: 0 16px;
        border: none;
    ...
    .joe_comment__upload-bar button:disabled { opacity: 0.6; cursor: not-allowed; }
</style>
            ...
            <div class="term">
                ...
                <div class="content">
                    <div class="user">
                        ...
                        <?php endif; ?>
                        <div class="agent"><?php if (Helper::options()->JCommentIp === 'on') : ?><?php convertip($comments->ip); ?> · <?php endif; ?><?php _getAgentOS($comments->agent); ?> · <?php _getAgentBrowser($comments->agent); ?></div>
                    </div>
                    <div class="substance">
