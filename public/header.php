<header class="joe_header <?php echo $this->is('post') ? 'current' : '' ?>">
    ...
    <div class="joe_header__slideout">
        ...
        <div class="joe_header__slideout-author">
            <img width="50" height="50" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php $this->options->JAside_Author_Avatar ? $this->options->JAside_Author_Avatar() : _getAvatarByMail(_getAsideAuthorInfo($this, 'mail')) ?>" alt="博主昵称" />
            <div class="info">
    ...
    <?php endif; ?>
         <!-- 哀悼模式 -->
    <?php if($this -> options -> aidao_ri == 'on'): ?>
