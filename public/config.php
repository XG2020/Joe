<script>
    ...
    window.Joe = {
        ...
        THEME_STATUS: `<?php echo $this->options->JGlobalThemeStatus === 'on' ? 'on' : 'off' ?>`,
...
<style>
    ...
    body::before {
        background: <?php if (_isMobile()) {
                        echo $this->options->JWallpaper_Background_WAP ? "url(" . $this->options->JWallpaper_Background_WAP . ")" : "var(--background)";
                    } else {
                        echo $this->options->JWallpaper_Background_PC ? "url(" . $this->options->JWallpaper_Background_PC . ")" : "var(--background)";
                    } ?>;
