...
<body>
	<div id="Joe">
		...
		<!--joe大图-->
		<?php if ($this->options->JBig_Banner !== "off") : ?>
			<div id="EvanBigBanner" class="evan-big-banner" style="background-image: url('<?php echo $this->options->JBig_Banner_Url; ?>');">
				<div class="infomation">
					<div id="EvanBigBanner_Title" class="title"><?php $this->options->title(); ?></div>
